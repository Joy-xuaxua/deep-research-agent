...
class SummarizationService:
    ...
    def summarize_task(self, state: ResearchState, task: ResearchTask, context: str) -> str:
    ...
    def _build_prompt(self, state: ResearchState, task: ResearchTask, context: str) -> str:
